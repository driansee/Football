...
class EventPreviousFragment : Fragment(), AnkoComponent<Context>, EventView {

    private var events: MutableList<Event> = mutableListOf()
    private lateinit var presenter: EventPresenter
    private lateinit var adapter: EventAdapter
    private lateinit var listPreviousMatch: RecyclerView
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        listPreviousMatch.adapter = adapter

        presenter = EventPresenter(this, ApiRepository(), Gson())
        presenter.getEventPrevious(id)
        swipeRefresh.onRefresh { presenter.getEventPrevious(id)}
                ...
                swipeRefresh = swipeRefreshLayout {
                    ...
                    scrollView {
                        ...
                        relativeLayout {
                            ...
                            listPreviousMatch = recyclerView {
                                lparams(matchParent, wrapContent)
    ...
    override fun showLoading() {
        progressBar.visible()
        listPreviousMatch.invisible()
        emptyDataView.invisible()
    }

    override fun hideLoading() {
        progressBar.invisible()
        listPreviousMatch.visible()
        emptyDataView.invisible()
    }
